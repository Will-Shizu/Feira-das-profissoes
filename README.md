# Site da Feira das Profissões
 Um projeto de um portal para divulgar o curso técnico em administação da E.E.E.P Profª Abigail Sampaio em um evento chamado **Feira das Profissões**, que tem a finalidade de apresentar os cursos da escola para os estudantes do 9° ano que tem a pretenção de igressar no ensino médio profissional.
